...
class NewUserTest(unittest.TestCase):
    ...
    def test_can_calculate_runs_for_vacation_from_homepage(self):
        ...
        miles_box = self.browser.find_element_by_id("miles")
        dest_city_box = self.browser.find_element_by_id("dest-city")
        dest_country_box = self.browser.find_element_by_id("dest-country")
        origin_city_box = self.browser.find_element_by_id("origin-city")
        origin_country_box = self.browser.find_element_by_id("origin-country")
